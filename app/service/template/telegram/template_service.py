...
class TelegramTemplateService:
    ...
    def render_base_template(self, template_type, template_name: str, *keys, **kwargs) -> str:
        """Renders a Telegram template."""
    ...
    @property
    def telegram_templates(self) -> TelegramTemplates:
        """Provides access to the TelegramTemplates instance."""
        return self._telegram_templates
